...
def main():
    ...
    output=ROOT/'results/body_motion_release_guard_regression_20260916';output.mkdir(exist_ok=False)
    ...
    try:
        ...
        assert guard.source_timeout([0.,3.4,6.8,10.2],6.)==6.
        result=dict(passed=True,source_silence_disables_sources=True,sparse_input_timeout_retained=True,motion_constraints=len(outputs),lidar_constraints=len(lidar_outputs),
