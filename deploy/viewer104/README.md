...
按提示输入 104 SSH 密码。桌面三个编号图标执行相同操作。详细操作和手动控制说明见桌面的 `237_启动104建图与显示.md`。
...
- 104 原始地图与位姿话题保持现有接口。当前正式地图为 `/T3/mapping/stereo_map`，局部/全局高程分别为 `/Car/T3/mapping/grid_map`、`/Car/T3/mapping/global_grid_map`。
